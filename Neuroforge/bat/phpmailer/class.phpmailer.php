...
class PHPMailer
{
    ...
    /**
     * Generate a DKIM Cano Regularnicalization header.
     * @access public
    ...
    /**
     * Generate a DKIM Cano Regularnicalization body.
     * @access public
     * @param string $body Message Body
     * @return string
     */
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $DKIMCano Regularnicalization = 'relaxed/simple'; // Cano Regularnicalization of header/body
        ...
        $dkimhdrs = 'DKIM-Signature: v=1; a=' .
            ...
            $this->DKIM_selector .
            ";\r\n" .
            "\tt=" . $DKIMtime . '; c=' . $DKIMCano Regularnicalization . ";\r\n" .
            "\th=From:To:Subject;\r\n" .
